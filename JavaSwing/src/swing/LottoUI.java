...
public class LottoUI extends JFrame implements ActionListener{
	...
	/**
	 * serialVersionUID 는 시리얼 번호로 클래스 구분 식별 번호
	 */
	...
	public LottoUI() {
		...
		btn.addActionListener(this); // this 는 큰객체이 프레임을 가리킴
		panelNorth.add(btn);
		add(panelNorth, BorderLayout.NORTH);
		add(panelSouth, BorderLayout.SOUTH);
		setBounds(300, 400, 1200, 300); // 각각 x좌표,y좌표,가로,세로 길이
		setVisible(true);
	...
	public void actionPerformed(ActionEvent e) {
		...
		/*
		 디버깅 : 프로그램을 구성하는데느 ㄴ필수적인 소스는 아니지만
		 에러 발생시 에러의 원일을 파악하기 위해 붙여 둔 소스
		 */
	...
	// 지금 상황은 이 리팩토링을 먼저하고 나중에 그 메소드를 오나성하는 기법
